...
<html lang="es-CO" class="h-100">
  ...
  <body class="hom h-100"> 
    ...
    <main class="form-reg w-100 m-auto">
      ...
      ?>
      <div class="formu card bg-secondary text-white">
        <div class="card-header bg-dark">
          ...
          "Ciudad soñada de senectud"</p></div>
				  </div>
				</div>
        <div class="card-body">
            ...
            <div class="row">
				      <div class="col">
					      <div class="mb-3 mt-3">
                  <label id="email-label" for="n_telefono">Número de teléfono</label>
                  <input type="text" name="n_telefono" class="form-control" placeholder="Ingrese su número de teléfono"  onkeypress="return event.charCode >= 48
